            ...
            <div className="order">
              ...
              <thead>
                <tr style={{ borderBottom: '1px solid #ddd' }}>
                  ...
                  <th style={{ padding: '10px', textAlign: 'center', borderBottom: '1px solid #ddd' }}>Education</th>
                </tr>
              </thead>
              <tbody>
                {users.map((user, index) => (
                  <tr key={index} style={{ borderBottom: '1px solid #ddd' }}>
                    ...
                    <td style={{ padding: '10px', textAlign: 'center', borderBottom: '1px solid #ddd' }}>{user.eduaction}</td>
                  </tr>
                ))}
              </tbody>
            </table>
