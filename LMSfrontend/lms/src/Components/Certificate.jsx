...
const Certificate = () => {
  ...
  >
    ...
    {loading ? (
      ...
      <div
        id="certificate"
        className="container text-center border border-primary p-4 rounded"
      ...
      >
        ...
        />
        <h1 className="text-primary mb-4" style={{ fontSize: "30px" }}>
          Certificate of Completion
        </h1>
        <p className="text-secondary mb-3" style={{ fontSize: "18px" }}>
        ...
        <img
          src={seal}
          alt="Signature"
          className="mt-4 border-top border-secondary"
